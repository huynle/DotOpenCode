...
- Run automated CLI tests using `opencode run`
...
**Command:**
```bash
opencode run "Use <toolname> to <basic-action>" --agent <agent-name>
```
...
**Command:**
```bash
opencode run "Use <toolname> with <param>=<value> to <action>" --agent <agent-name>
```
...
**Command:**
```bash
opencode run "Use <toolname_variant> to <action>" --agent <agent-name>
```
