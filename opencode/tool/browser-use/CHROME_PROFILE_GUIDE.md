...
```
/Users/huy/Library/Application Support/Google/Chrome/Default
```
...
**Note:** When using Chrome profiles, you can work in local mode without requiring a Browser Use Cloud API key, making it perfect for accessing your personal authenticated sites.
...
```bash
opencode run "Use the execute tool to go to Facebook and check my notifications. Use chromeProfile='/Users/huy/Library/Application Support/Google/Chrome/Default' and headless=false" --agent tooling
```

### Example 2: Access Private GitHub Repository

```bash
opencode run "Use the extractData tool to extract repository information from https://github.com/your-private-repo. Use chromeProfile='/Users/huy/Library/Application Support/Google/Chrome/Default', dataDescription='repository stars, forks, and recent commits', and headless=false" --agent tooling
```

### Example 3: LinkedIn Profile Data

```bash
opencode run "Use the execute tool to go to my LinkedIn profile and extract my connections count and recent activity. Use chromeProfile='/Users/huy/Library/Application Support/Google/Chrome/Default' and headless=false" --agent tooling
```

### Example 4: Twitter/X Timeline

```bash
opencode run "Use the execute tool to go to Twitter and get my latest 5 tweets from my timeline. Use chromeProfile='/Users/huy/Library/Application Support/Google/Chrome/Default' and headless=false" --agent tooling
```
...
// Example 1: Facebook automation
const facebookResult = await execute({
...
To see what's happening, always use `headless: false` during development:
