...
- **Testing Isolation**: Test OpenCode commands/agents/tools using `OPENCODE_CONFIG_DIR=$PWD/opencode opencode`
- **Command Testing**: Run `OPENCODE_CONFIG_DIR=$PWD/opencode opencode run "hello world"` with custom config directory for feature testing
